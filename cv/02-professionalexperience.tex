  ...
  \cventry
    ...
    {July 2022 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
          ...
          \begin{itemize}
              \item Provided direct data support to the Superintendent's Initiatives, including:
              \begin{itemize}
                  \item Data integration for CalKIDS, supporting districts in registering over 32,000 students and facilitating access to \$16,000,000 in college funding.
                  \item Identification of schools demonstrating equitable and inclusive outcomes as part of the Equity and Inclusive Practices Initiative.
                  \item Piloted an Early Literacy integrated data portal to harmonize data across multiple early literacy screeners.
                  \item Data support for the Mental Health Initiative, including:
                  \begin{itemize}
                      \item Efforts to improve coordination between Managed Care Plans and school districts (SBHIP).
                      \item Suicide prevention efforts (SPARE).
                      \item Socioemotional learning support (CalHOPE).
                      \item Enhanced data systems for Whole Health Screening (MHSSA).
                  \end{itemize}
              \end{itemize}
              \item Architected a countywide data system, which included:
              \begin{itemize}
                  \item Setting up an on-premises Kubernetes cluster to host a full-stack data system.
                  \item Infrastructure components included:
                  \begin{itemize}
                      \item Minio S3-compatible storage layer.
                      \item Airflow for data orchestration.
                      \item dbt for ELT processing.
                      \item SQL Server 2022 for the data warehouse.
                      \item Tableau for data visualization, with associated row-level security.
                  \end{itemize}
              \end{itemize}
          \end{itemize}
          \item {[TODO: Add additional research and data analysis accomplishment]}
          \item {[TODO: Add additional research and data analysis accomplishment]}
          \item {[TODO: Add additional research and data analysis accomplishment]}
          \item LEADERSHIP AND CONTINUOUS IMPROVEMENT
          \begin{itemize}
            \item {Co-facilitator of Data Culture Workgroup for the Southern California GeoArea
            as GeoLead member, supporting other County Office of Education colleagues in
            improving data culture within their COE and respective districts.}
            \item {[TODO: Add additional leadership and continuous improvement accomplishment]}
            \item {[TODO: Add additional leadership and continuous improvement accomplishment]}
            \item {[TODO: Add additional leadership and continuous improvement accomplishment]}
          \end{itemize}
      \end{cvitems}
...
%---------------------------------------------------------
  \cventry
    {Data Coordinator} % Job title
    {Riverside County Office of Education} % Organization
    {Riverside, CA} % Location
    {Apr 2018-June 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
          \item RESEARCH AND DATA ANALYSIS
          \begin{itemize}
            ...
            College Board data in partnership with UC Riverside for use as part of the
...
%---------------------------------------------------------
  \cventry
    {Curriculum and Instruction Coordinator} % Job title
    {Menifee Union School District} % Organization
    {Menifee, CA} % Location
    {Jun 2016-Apr 2018} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
          \item RESEARCH AND DATA ANALYSIS
          \begin{itemize}
            ...
            \item {Implemented Tableau real-time demographic report utilizing PostgreSQL
